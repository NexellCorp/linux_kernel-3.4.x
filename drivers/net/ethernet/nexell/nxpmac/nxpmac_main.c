...
#undef NXPMAC_RX_DEBUG
/*#define NXPMAC_RX_DEBUG*/
#ifdef NXPMAC_RX_DEBUG
#define RX_DBG(fmt, args...)  printk(fmt, ## args)
#else
#define RX_DBG(fmt, args...)  do { } while (0)
#endif

#undef NXPMAC_XMIT_DEBUG
/*#define NXPMAC_XMIT_DEBUG*/
#ifdef NXPMAC_TX_DEBUG
...
#if defined(NXPMAC_XMIT_DEBUG) || defined(NXPMAC_RX_DEBUG)
