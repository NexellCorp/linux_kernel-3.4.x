...
nxp_fb_init_display(struct fb_info *info)
{
	...
	printk(KERN_INFO "%s: %d * %d - %d bpp (phys:%08x virt:0x%p max:%d)\n",
		info->fix.id, xres, yres, pixel<<3,
...
static void nxp_fb_setup_param(struct fb_info *info, void *data)
{
