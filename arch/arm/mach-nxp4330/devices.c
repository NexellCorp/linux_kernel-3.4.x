...
static void pl011_uart0_prepare(void)
{
	NX_UART_CH_INIT(0);
...
static void pl011_uart2_prepare(void)
{
	NX_UART_CH_INIT(2);
...
static void pl011_uart3_prepare(void)
{
	NX_UART_CH_INIT(3);
...
static void pl011_uart4_prepare(void)
{
	NX_UART_CH_INIT(4);
...
static void pl011_uart5_prepare(void)
{
	NX_UART_CH_INIT(5);
...
static struct resource nxp4330_ohci_resource[] = {
