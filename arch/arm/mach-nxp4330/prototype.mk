...
obj-$(CONFIG_NEXELL_SOC_DISP)			+= 	$(PROTOTYPE)/$(MODULES)/nx_displaytop.o		\
...
obj-$(CONFIG_NEXELL_SOC_DISP_LVDS)		+= 	$(PROTOTYPE)/$(MODULES)/nx_lvds.o
obj-$(CONFIG_NEXELL_SOC_DISP_RESCONV)	+= 	$(PROTOTYPE)/$(MODULES)/nx_resconv.o
obj-$(CONFIG_NEXELL_SOC_DISP_HDMI)		+= 	$(PROTOTYPE)/$(MODULES)/nx_hdmi.o
obj-$(CONFIG_NEXELL_SOC_DISP_HDMI)		+= 	$(PROTOTYPE)/$(MODULES)/nx_ecid.o
obj-$(CONFIG_NEXELL_SOC_DISP_MIPI)		+=  $(PROTOTYPE)/$(MODULES)/nx_mipi.o
...
obj-$(CONFIG_NXP4330_MP2TS_IF)			+=  $(PROTOTYPE)/$(MODULES)/nx_mpegtsi.o
